...
where
    ...
    A: apis::auth::Auth<E, Claims = C> + apis::corners::Corners<E, Claims = C> + apis::episodes::Episodes<E, Claims = C> + apis::podcasts::Podcasts<E, Claims = C> + apis::scripts::Scripts<E, Claims = C> + apis::secrets::Secrets<E, Claims = C> + apis::tasks::Tasks<E, Claims = C> + apis::ApiAuthBasic<Claims = C> + Send + Sync + 'static,
